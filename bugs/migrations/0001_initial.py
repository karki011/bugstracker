    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_assigned', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Assigned', to=settings.AUTH_USER_MODEL)),
                ('user_completed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Completed', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
